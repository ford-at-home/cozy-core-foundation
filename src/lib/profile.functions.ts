...
export const saveMyProfile = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }): Promise<{ profile: Profile }> => {
    ...
    const textStylePreset =
      typeof data.textStylePreset === "string" ? data.textStylePreset.trim() || null : null;
    const imageStylePreset =
      typeof data.imageStylePreset === "string" ? data.imageStylePreset.trim() || null : null;
      ...
      .upsert(
        {
          ...
          text_style_preset: textStylePreset,
